Vagrant.configure(2) do |config|
  ...
  # Elasticsearch server. Name it by IP address, to facilitate test playbook.
  config.vm.define "192.168.33.50" do |m|
    m.vm.box = "ubuntu/trusty64"
    m.vm.network "private_network", ip: "192.168.33.50"
    ...
    m.vm.provision "ansible" do |ansible|
      ansible.playbook = "tests/elasticsearch.yml"
      ansible.groups = { "elasticsearch" => [ "192.168.33.50" ] }
      ansible.verbose = 'vv'
    end
  end
